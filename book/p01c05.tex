...
If you wish, you can follow along by training networks on your computer. It is also, of course, fine to just read along. If you do wish to follow live, then you'll need Python, Numpy, and a copy of the code, which you can get by cloning the relevant repository from the command line: 

For Python 2.7:
\lstinline{git clone https://github.com/mnielsen/neural-networks-and-deep-learning.git}\\
For Python 3:
\lstinline{git clone https://github.com/MichalDanielDobrzanski/DeepLearningPython35.git}
...
\textbf{Why the vanishing gradient problem occurs: }\label{page:Whythevanishinggradientproblemoccurs}
