...
%\includeonly{c14}
%\includeonly{p05c01,p05c02,cbib}
%\includeonly{p05c08,cbib}
...
\include{p05c03} % Estimating Probabilities with Bayesian Modeling in Python Koehrsen
\include{p05c04} % Linear regression
\include{p05c05} % Introduction to Probability and Computational Bayesian Statistics
\include{p05c06} % Markov chaines
\include{p05c07} % Bayesian inference, MCMC and variational inference
\include{p05c08} % Bayesian Inference, Markov Chain Monte Carlo and Metropolis Hastings, in python
