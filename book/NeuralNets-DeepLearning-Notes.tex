...
\includeonly{cf00,c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c0a,c0b,cbib}
...
\include{c02} %[[Done]] How the Backpropagation Algorithm Works 
\include{c03} %Improving the Way Neural Networks Learn 
\include{c04} %[[Done]] A Visual Proof That Neural Nets Can Compute Any Function 
\include{c05} %Why are deep neural networks hard to train?
\include{c06} %deep learning
\include{c07} %[[Done]] algorithm for intelligence?   
\part{Study Notes: Nelis Willers}
\include{c08} %activation/nonlin functions
\include{c09} %visualising classifiers
\include{c10} %data preparation
\part{Supplementary Notes}
\include{c0a} %Environment Setup
\include{c0b} %Python and Jupyter Code
