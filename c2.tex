...
, we can begin with a matrix X=[x1x2?xm]
...
alone (we'll get back to the biases in a moment). You number the weights $w_1$,w2,?, and want to compute ?C/?wj for some particular weight wj. An obvious way of doing that is to use the approximation 
?C?wj?C(w+?ej)?C(w)?,(46)
