...
We use a similar notation for the network's biases and activations. Explicitly, we use $b^l_j$ for the bias of the \mth{j} neuron in the \mth{l} layer. And we use $a^l_j$ for the activation of the \mth{j} neuron in the \mth{l} layer. The following diagram shows examples of these notations in use: 
...
{\centering \includegraphics[width=\textwidth,]{pic/tikz22.png} \par}

That change in weight will cause a change in the output activation from the corresponding neuron: 

{\centering \includegraphics[width=\textwidth,]{pic/tikz23.png} \par}

That, in turn, will cause a change in \textit{all} the activations in the next layer: 

{\centering \includegraphics[width=\textwidth,]{pic/tikz24.png} \par}
...
{\centering \includegraphics[width=\textwidth,]{pic/tikz25.png} \par}
...
{\centering \includegraphics[width=\textwidth,]{pic/tikz26.png} \par}
...
{\centering \includegraphics[width=\textwidth,]{pic/tikz27.png} \par}
